...
1. 저장소를 클론 또는 다운로드
2. 프로젝트 폴더 안의 `index.html` 파일을 브라우저 열기
...
안준영:
GitHub를 활용해 팀원들과 소통하며 Commit, Push, Merge Conflict 등 실무 협업을 몸소 경험했습니다.
이번 프로젝트에서 Gallery 파트를 맡아 진행하였으며 실제 가수 웹사이트에서 사용하는 템플릿을 직접 내 손으로 만들어보니 감회가 새로웠던 것 같습니다. 처음엔 커밋과 푸시가 되지않아 막히고, conflic 문제가 지속해서 일어나 잠시 멘붕이 일어나기도 했었지만, 계속해서 작업하면서 pull before push를 꾸준히 계속 해야되는 것을 깨닫게 되었습니다. 이번 프로젝트는 살면서 처음 해본 경험이였지만, 협업의 중요성을 느낄 수 있는 좋은 시간이 된 것 같습니다!
